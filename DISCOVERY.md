...
#### Direct Attributes
- **committer**: root
- **tagged_date**: 2026-02-20 05:08:59+00:00
- **tagger**: github-actions[bot]
- **version**: 0.1.0

#### Elements Structure

Element types available: features, unknown, bug fixes, refactoring, chores, documentation, continuous integration, testing

##### BUG FIXES Elements (39 total)
...
#### Direct Attributes
- **committer**: root
- **tagged_date**: 2026-02-20 05:09:44+00:00
- **tagger**: github-actions[bot]
- **version**: 0.1.1
...
#### Direct Attributes
- **committer**: root
- **tagged_date**: 2026-02-20 05:10:28+00:00
- **tagger**: github-actions[bot]
- **version**: 1.0.0
...
- **tagged_date**: 2026-02-20 05:11:56.964155+00:00
- **tagger**: github-actions[bot]
- **version**: 1.0.1

#### Elements Structure

Element types available: bug fixes, documentation
...
##### DOCUMENTATION Elements (2 total)
...
Release `v1.0.1` on: `2026-02-20`
Full format: `February 20, 2026 at 05:11`
...
- Element types: `bug fixes, documentation`
- Total commits:
4
- Breakdown by type:
  - bug fixes: 2
